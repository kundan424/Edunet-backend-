import os
base = 'src/main/java/com/edtech/platform/dashboard/controller'

dashboard_controller = '''package com.edtech.platform.dashboard.controller;
...
'''
with open(f'{base}/DashboardController.java', 'w') as f: f.write(dashboard_controller)
