...
# We need to find the correct ending of handleQuizCompletedEvent
idx = c.find('    public void handleQuizCompletedEvent(QuizCompletedEvent event) {')
end_idx = c.find('}', c.find('}', idx) + 1) + 1
