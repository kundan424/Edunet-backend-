import os
base = 'src/test/java/com/edtech/platform/dashboard'

test_content = '''package com.edtech.platform.dashboard;

import com.edtech.platform.course.entity.Course;
import com.edtech.platform.course.entity.PublishStatus;
import com.edtech.platform.course.repository.CourseRepository;
import com.edtech.platform.enrollment.entity.Enrollment;
import com.edtech.platform.enrollment.entity.EnrollmentStatus;
...
public class DashboardIntegrationTest {
    ...
    void setUp() {
        ...
        p1.setAmount(BigDecimal.valueOf(100.00));
        ...
        p2.setAmount(BigDecimal.valueOf(100.00));
    ...
    void testInstructorDashboardSuccessAndRevenue() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/dashboard/instructor")
                ...
                .andExpect(jsonPath("$.data.totalRevenue", is(0.0)));
    }
    ...
    void testInstructorDashboardDateValidation() throws Exception {
        mockMvc.perform(get("/api/v1/dashboard/instructor?from=2026-12-31&to=2026-01-01")
                .header("Authorization", "Bearer " + instructor1Token))
                .andExpect(status().isBadRequest()); // From after To
    }
}
'''
with open(f'{base}/DashboardIntegrationTest.java', 'w') as f: f.write(test_content)
